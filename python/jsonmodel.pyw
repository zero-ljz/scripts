...
from PySide6.QtWidgets import QTreeView, QApplication, QHeaderView, QFileDialog, QMessageBox
...
if __name__ == "__main__":
    ...
    # 定义一个自定义槽来处理aboutToQuit信号
    def on_about_to_quit():

        reply = QMessageBox.question(
            None,
            "Save Changes",
            "Do you want to save the changes to the JSON file?",
        ...
        if reply == QMessageBox.Save:
            ...
            app.quit()  # Cancel exit
        

    # 将aboutToQuit信号连接到自定义插槽
